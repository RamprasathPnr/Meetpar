...
public class FullScreenVideoActivity extends AppCompatActivity {
    ...
    private ProgressBar progressBar;
      ...
      private static String selectedUrl = "https://5c75277727cd1.streamlock.net/Meetpartv/Meetpartv/playlist.m3u8";
   // private static String selectedUrl = "https://bitdash-a.akamaihd.net/content/sintel/hls/playlist.m3u8";
    ...
    public void onBackPressed() {
        if (mExoPlayerFullscreen) {
            ...
            if (Settings.System.getInt(getContentResolver(), Settings.System.ACCELEROMETER_ROTATION, 0) == 1) {
                ...
                Intent intent = new Intent(FullScreenVideoActivity.this,DashboardActivity.class);
